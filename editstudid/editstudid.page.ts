...
@Component({
  selector: 'app-editstudid',
  templateUrl: './editstudid.page.html',
  styleUrls: ['./editstudid.page.scss'],
})
export class EditstudidPage implements OnInit {
  ...
  constructor(private crt:CreateRecordService,
    ...
    newstudIDForm = this.formB.group({
      newStudID:[''],})
  ...
  async updateStudID(){
    ...
    var newstudID = this.newstudIDForm.value.newStudID;
