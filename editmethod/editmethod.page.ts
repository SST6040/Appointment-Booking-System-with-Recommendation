...
@Component({
  ...
  templateUrl: './editmethod.page.html',
  styleUrls: ['./editmethod.page.scss'],
})
export class EditmethodPage implements OnInit {
  ...
  constructor(private crt:CreateRecordService,
    ...
    newMethodForm = this.formB.group({
      newMethod:[''],})
  ngOnInit() {
  }
  ...
  async updateMethod(){
    ...
    var newmethod = this.newMethodForm .value.newMethod;
